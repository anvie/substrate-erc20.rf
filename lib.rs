...
//! 
//! Copyright (C) $year$ $param.author_name$ <$param.author_email_lower_case$>
//! 
//! $param.description$
//! 
...
mod $name_snake_case$ {
    ...
    mod tests {
        ...
        #[ink::test]
        fn new_works() {
            let contract = $name_pascal_case$::new(2100);
        ...
        #[ink::test]
        fn balance_works() {
            let contract = $name_pascal_case$::new(100);
        ...
        #[ink::test]
        fn transfer_works() {
            let mut contract = $name_pascal_case$::new(100);
            assert_eq!(contract.balance_of(AccountId::from([0x0; 32])), 0);
